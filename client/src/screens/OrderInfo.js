/*
 * @Author: G.F
 * @Date: 2021-07-28 23:07:35
 * @LastEditTime: 2021-07-28 23:36:16
 * @LastEditors: your name
 * @Description: 
 * @FilePath: /React-Node/client/src/screens/OrderInfo.js
 */
...
export default function OrderInfo(param) {
    ...
    useEffect(() => {
        dispatch(getOrderById(param.match.params.orderId));
    }, [dispatch]);
